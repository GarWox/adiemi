      ...
      <Modal isOpen={isOpen} onClose={() => setIsOpen(false)}>
        ...
        <div className="modalContainerSteps">
          <div className="stepImgContainer">
            <img className="imgStep" src={step1} alt="pasos" />
          </div>
          <div className="stepImgContainer">
            <img className="imgStep" src={step2} alt="pasos" />
          </div>
          <div className="stepImgContainer">
            <img className="imgStep" src={step3} alt="pasos" />
          </div>
          <div className="stepImgContainer">
            <img className="imgStep" src={step4} alt="pasos" />
          </div>
        </div>
      </Modal>
    </section>
