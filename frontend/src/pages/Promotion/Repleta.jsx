...
import PromoR from '../../assets/images/Repleta.jpg';
...
const Repleta = () => {
  const [isOpen, setIsOpen] = useState(false);
      ...
      const carouselImages = [
        { id: 1, src: PromoR, alt: "Promo Repleta" },
      ...
      const handleOrder = () => {
        ...
        setOrderData({
          promotionName: "Promoción Repleta",
      ...
      return (
        <>
          ...
          {/* Modal de pasos */}
          <Modal isOpen={isOpen} onClose={() => setIsOpen(false)} className="modal">
            ...
            <div className="order-confirmation">
              ...
              <div className='imagen-part' >
                <div className='image-container'>
                  <img src={PromoR} alt="promo Tradicional" />
                </div>
